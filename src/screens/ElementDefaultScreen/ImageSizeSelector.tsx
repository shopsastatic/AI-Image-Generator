...
const ImageSizeSelector: React.FC<ImageSizeSelectorProps> = ({
    ...
    const fetchSubcategories = async () => {
        try {
            ...
            if (data.success) {
                ...
                console.error(
                    "❌ Failed to fetch filtered subcategories:",
                    data.error
                );
                setSubcategories([]);
            }
    ...
    const handleMouseDown = (e: React.MouseEvent) => {
        ...
        const thumbPosition =
            rect.left + (rect.width * (numberOfImages - 1)) / 4;
        const thumbWidth = 20;
    ...
    return (
        <div>
            <div className="relative inline-block" ref={dropdownRef}>
                ...
                >
                    {React.createElement(
                        getIconForAspectRatio(selectedAspectRatio),
                        {
                    ...
                    <div className="absolute bottom-full left-0 mt-2 bg-white border border-gray-300 rounded-lg shadow-xl z-50 w-80 overflow-hidden mb-2">
                        ...
                        <div className="flex items-center space-x-2 p-3 border-b border-gray-200 bg-gray-25">
                            ...
                            <select
                                value={childOption}
                                onChange={(e) =>
                                    handleChildOptionChange(e.target.value)
                                }
                                disabled={
