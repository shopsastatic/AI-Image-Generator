...
const ProjectManagement: React.FC = () => {
    ...
    const [showQuickAddSubcategory, setShowQuickAddSubcategory] =
        useState(false);
    ...
    const handleDeleteSelectedSubcategory = async () => {
        ...
        const subcategoryToDelete = subcategories.find(
            (sub) =>
                ...
                sub.value === formData.subcategory
        );
    ...
    const fetchProjects = useCallback(async () => {
        try {
            ...
            if (data.success) {
                ...
                console.log(
                    `📊 Loaded ${data.projects.length} instruction projects`
                );
            } else {
    ...
    const previewInstructionContent = async () => {
        try {
            ...
            if (data.success) {
                if (data.exists) {
                    console.log(
                        `📖 Loading existing content from: ${data.filename}`
                    );
    ...
    const fetchSubcategories = useCallback(async () => {
        try {
            ...
            console.log(
                "🔄 ProjectManagement: Fetching subcategories from API..."
            );
            ...
            console.error(
                "ProjectManagement: Error fetching subcategories:",
                error
            );
            setSubcategories([]);
        } finally {
    ...
    const saveProject = async (projectData: FormData) => {
        try {
            ...
            const requestBody = {
                ...projectData,
                originalFilename: editingProject
            ...
            if (data.success) {
                ...
                if (
                    response.status === 409 &&
                    data.type === "CONFIGURATION_CONFLICT"
                ) {
...
${conflictData.suggestions.map((s: string) => `• ${s}`).join("\n")}
  `.trim();
    ...
    const deleteProject = async (filename: string) => {
        try {
            const response = await fetch(
                `/api/instructions/projects/${filename}`,
                {
                    method: "DELETE",
                }
            );
    ...
    const loadProjectContent = async (filename: string) => {
        try {
            const response = await fetch(
                `/api/instructions/content/${filename}`
            );
            const data = await response.json();
    ...
    const handleSaveSubcategory = async () => {
        console.log(
            "🔄 handleSaveSubcategory called - current tab:",
            activeTab
        );
        ...
        if (result.success) {
            console.log(
                "✅ saveSubcategory success - staying on tab:",
                activeTab
            );
    ...
    const handleDeleteSubcategory = async (subcategory: SubcategoryOption) => {
        console.log(
            "🔄 handleDeleteSubcategory called - current tab:",
            activeTab
        );
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600">
                                Manage AI instruction prompts and subcategories
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl max-w-5xl w-full max-h-[95vh] overflow-y-auto">
                            ...
                            <div className="p-8 space-y-8">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center justify-between mt-2">
                                        <div className="text-xs text-gray-500">
                                            This content will be used as the
                                            instruction prompt for AI generation
                                        </div>
                                        <div className="text-xs text-gray-500">
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                            ...
                            <div className="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    />
                                    <div className="text-xs text-gray-500 mt-1">
                                        This is the human-readable name that
                                        will be displayed in dropdowns
                                    </div>
                                </div>
                                <div>
                                    <label className="block text-sm font-semibold text-gray-900 mb-2">
                                    ...
                                    />
                                    <div className="text-xs text-gray-500 mt-1">
                                        This is the internal identifier used in
                                        the system. Use lowercase with hyphens.
